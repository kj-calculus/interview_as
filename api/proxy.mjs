...
const allowed=/^(?:login|logout|me|password|state|important-events(?:\/[a-f0-9-]+)?|lesson-progress|submissions(?:\/assignments|\/(?:files|assignment-files)\/[a-f0-9-]+)?|applications|results|availability|resources(?:\/(?:files\/)?[a-f0-9-]+)?|accounts(?:\/(?:validate|reset-password|classes|delete))?|events(?:\/[a-zA-Z0-9-]+)?)$/;
